...
github:::
Creates a GitHub Code Quality report `report.github.md` that you can add to the job summary environment variable with `cat target/code-analysis/report.github.md >> $GITHUB_STEP_SUMMARY` in your workflow job.
